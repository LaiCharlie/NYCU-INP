...
:bulb: Every <message> in <chat_history> should also be filtered (see here). If there is a pin message, add a mark after Record n in the format Pin -> [<username>]: <message>\n.(see here)
